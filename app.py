...
st.title('XGBoost Model Prediction for Bank Marketing Campaign')
...
if 'sample_data' in st.session_state:
    ...
    st.write("Please Press Predict to Get Predictions of XGBoost Model")
...
if 'sample_data' in st.session_state and st.button('Predict'):
    ...
    st.session_state.sample_data['Correct Prediction'] = np.where(
        st.session_state.sample_data['Predicted Label'] == st.session_state.sample_data['y'], 
        'Yes', 
        'No'
    )
